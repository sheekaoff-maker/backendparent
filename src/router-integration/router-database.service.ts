...
const VENDOR_NAME_PATTERNS: Array<{ pattern: RegExp; pluginId: string }> = [
  ...
  { pattern: /keenetic/i, pluginId: 'keenetic' },
  ...
  { pattern: /totolink/i, pluginId: 'totolink' },
  { pattern: /sercomm/i, pluginId: 'sercomm' },
  { pattern: /actiontec/i, pluginId: 'actiontec' },
  { pattern: /hitron/i, pluginId: 'hitron' },
  { pattern: /comtrend/i, pluginId: 'comtrend' },
  { pattern: /nokia/i, pluginId: 'nokia_home_gateway' },
