...
export class DnsPolicyResponseDto {
  ...
  @ApiProperty({
    ...
    enum: ['FULL_INTERNET_LOCK', 'STRICT_MODE_DOH', 'TIME_LIMIT_EXCEEDED', 'DOMAIN_BLOCKED', 'CATEGORY_BLOCKED', 'GAMING_BLOCKED', 'MANUAL_BLOCK', 'SESSION_VIOLATED', null],
    example: 'FULL_INTERNET_LOCK',
    required: false,
  })
  reason: 'FULL_INTERNET_LOCK' | 'STRICT_MODE_DOH' | 'TIME_LIMIT_EXCEEDED' | 'DOMAIN_BLOCKED' | 'CATEGORY_BLOCKED' | 'GAMING_BLOCKED' | 'MANUAL_BLOCK' | 'SESSION_VIOLATED' | null;
